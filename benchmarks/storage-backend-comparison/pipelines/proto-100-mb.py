...
desired_size_bytes = 100 * 1024 * 1024  # 100MB
...
csv_file_path = '../generated-data/random_data_100MB.csv'
df.to_csv(csv_file_path, index=False)

loaded_df=pd.read_csv('../generated-data/random_data_100MB.csv', index_col=0)
