...
desired_size_bytes = 10 * 1024 * 1024  # 10MB
...
csv_file_path = '../generated-data/random_data_10MB.csv'
df.to_csv(csv_file_path, index=False)

loaded_df=pd.read_csv('../generated-data/random_data_10MB.csv', index_col=0)
