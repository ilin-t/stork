...
# dataset key is caught by the AST traverser
# implement this here
...
# begin - downloader side

s3connector.download_file(dataset_key)
# If the pipeline processes the data with pandas, return dataframe object
# Otherwise, return the type of object that was detected by the traversal
