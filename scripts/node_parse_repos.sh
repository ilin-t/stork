...
python3 src/log_modules/parse_requirements.py --threads=36 --packages=$ROOT/$REPOSITORY/packages/ --outputs=$ROOT/results/$DATE-$REPOSITORY/ --repositories=$ROOT/$REPOSITORY/repositories/
