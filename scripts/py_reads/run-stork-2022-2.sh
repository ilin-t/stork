...
python3 benchmarks/run_mt.py --threads=36 --repositories=$ROOT/results/21-11-2023-16-26-stork-zip-flag-year-2023/repositories/library_reads/aggregated_results.txt --split=2 --outputs=$ROOT/results/$DATE-$REPOSITORY-year-$YEAR/ --split=2 --pipelines=$ROOT/results/21-11-2023-16-26-stork-zip-flag-year-2023/pipelines/library_reads/aggregated_results.txt
