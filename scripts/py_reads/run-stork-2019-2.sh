...
python3 benchmarks/run_mt.py --threads=36 --repositories=$ROOT/results/21-11-2023-12-10-stork-zip-flag-year-2019/repositories/library_reads/aggregated_results.txt --outputs=$ROOT/results/$DATE-$REPOSITORY-year-$YEAR/ --split=2 --pipelines=$ROOT/results/21-11-2023-12-10-stork-zip-flag-year-2019/pipelines/library_reads/aggregated_results.txt
