...
p1 = Process(target=get_repos, args=(years[0], months[0:2], days, pages, token1,))
p2 = Process(target=get_repos, args=(years[0], months[2:4], days, pages, token2,))
p3 = Process(target=get_repos, args=(years[0], months[4:6], days, pages, token3,))
p4 = Process(target=get_repos, args=(years[0], months[6:8], days, pages, token4,))
p5 = Process(target=get_repos, args=(years[0], months[8:10], days, pages, token5,))
p6 = Process(target=get_repos, args=(years[0], months[10:12], days, pages, token6,))
p7 = Process(target=get_repos, args=(years[1], months[0:2], days, pages, token7,))
p8 = Process(target=get_repos, args=(years[1], months[2:4], days, pages, token8,))
p9 = Process(target=get_repos, args=(years[1], months[4:6], days, pages, token9,))
p10 = Process(target=get_repos, args=(years[1],months[6:8], days, pages, token10,))
p11 = Process(target=get_repos, args=(years[1], months[8:10], days, pages, token11,))
p12 = Process(target=get_repos, args=(years[1], months[10:12], days, pages, token12,))
p13 = Process(target=get_repos, args=(years[2], months[0:2], days, pages, token13,))
p14 = Process(target=get_repos, args=(years[2], months[2:4], days, pages, token14,))
p15 = Process(target=get_repos, args=(years[2], months[4:6], days, pages, token15,))
p16 = Process(target=get_repos, args=(years[2], months[6:8], days, pages, token16,))
p17 = Process(target=get_repos, args=(years[2], months[8:10], days, pages, token17,))
p18 = Process(target=get_repos, args=(years[2], months[10:12], days, pages, token18,))
p19 = Process(target=get_repos, args=(years[3], months[0:2], days, pages, token19))
p20 = Process(target=get_repos, args=(years[3], months[2:4], days, pages, token20))
p21 = Process(target=get_repos, args=(years[3], months[4:6], days, pages, token21))
p22 = Process(target=get_repos, args=(years[3], months[6:8], days, pages, token22,))
p23 = Process(target=get_repos, args=(years[3], months[8:10], days, pages, token23))
p24 = Process(target=get_repos, args=(years[3], months[10:12], days, pages, token24))
p25 = Process(target=get_repos, args=(years[4], months[0:2], days, pages, token25))
p26 = Process(target=get_repos, args=(years[4], months[2:4], days, pages, token26,))
p27 = Process(target=get_repos, args=(years[4], months[4:6], days, pages, token27))
p28 = Process(target=get_repos, args=(years[4], months[6:8], days, pages, token28,))
p29 = Process(target=get_repos, args=(years[4], months[8:10],days, pages, token29,))
p30 = Process(target=get_repos, args=(years[4], months[10:12], days, pages, token30,))
