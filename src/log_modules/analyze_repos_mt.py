...
def generate_requirements(repos_root, packages_root, outputs_root, part):
    missing_repositories = createLoggerPlain(filename=f"{outputs_root}missing_repositories-{part}.log",
                                             project_name=f"missing_repositories-{part}", level=logging.INFO)
    repositories_totals = createLoggerPlain(filename=f"{outputs_root}repo_stats/stats-{part}.log",
                                            project_name=f"stats-{part}", level=logging.INFO)
