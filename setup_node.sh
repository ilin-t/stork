...
python3 src/log_modules/parse_repos.py --threads=12 --repos=/hpi/fs00/share/fg-rabl/ilin.tolovski/stork-zip-download/repositories-test/ --packages=/hpi/fs00/share/fg-rabl/ilin.tolovski/stork-zip-download/packages/ --outputs=/hpi/fs00/share/fg-rabl/ilin.tolovski/stork-zip-download/outputs/
python3 src/log_modules/parse_requirements.py --threads=12 --packages=/hpi/fs00/share/fg-rabl/ilin.tolovski/stork-zip-download/packages/
